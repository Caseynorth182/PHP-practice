                        ...
                        <div class="panel-content">
                           <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                            ...
                            <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                <img src="<?=$data['options']['image_url']?>" alt="<?=$data['name'];?>" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                <div class="ml-2 mr-3">
                                    <h5 class="m-0">
                                    ...
                                    <a href="https://twitter.com/<?=$data['options']['twitter_login'];?>" class="text-info fs-sm" target="_blank"><?=$data['options']['twitter_login'];?></a> -
                                    <a href="<?=$data['options']['email']?>" class="text-info fs-sm" target="_blank" title="Contact Sunny"><i class="fal fa-envelope"></i></a>
                                </div>
                            </div>
